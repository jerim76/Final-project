...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///agritech.db').replace('postgres://', 'postgresql://', 1) if os.environ.get('DATABASE_URL') else 'sqlite:///agritech.db'
...
MODEL_CLASSES = [
    'healthy','leaf curl','leaf blight','septoria leaf spot','verticulim wilt'
]
